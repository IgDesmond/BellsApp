...
try:
    ...
    departments = [
        "AGRICULTURAL AND BIOSYSTEMS ENGINEERING", "AGRICULTURE AND AGRICULTURAL TECHNOLOGY",
        "ARCHITECTURE", "BIOLOGICAL SCIENCES", "BIOMEDICAL ENGINEERING", "BUILDING TECHNOLOGY",
        "BUSINESS ADMINISTRATION", "CHEMICAL SCIENCES", "CIVIL AND ENVIRONMENTAL ENGINEERING",
        "COMPUTER ENGINEERING", "COMPUTER SCIENCE AND INFORMATION TECHNOLOGY",
        "ECONOMICS, ACCOUNTING AND FINANCE", "ELECTRICAL ELECTRONICS AND TELECOMMUNICATION ENGINEERING",
        "ESTATE MANAGEMENT", "FOOD SCIENCE AND TECHNOLOGY", "MANAGEMENT TECHNOLOGY", "MECHANICAL ENGINEERING",
        "MECHATRONICS ENGINEERING", "PHYSICAL SCIENCES", "QUANTITY SURVEYING", "SURVEYING & GEOINFORMATICS",
    ...
    selected_dept = st.multiselect(
        ...
        departments,
        default=["AGRICULTURAL AND BIOSYSTEMS ENGINEERING"],
        max_selections=1
    )
